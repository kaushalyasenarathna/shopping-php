...
?>									
										<tr>
											...
											<td><a href="productview.php?id=<?php echo $row['id'];?>"><?php echo htmlentities($row['productName']);?></a>
											...
											<td>
											<a href="edit-products.php?id=<?php echo $row['id']?>" > <img src="up.jpg"  width="30px" height="25px"></a>
											<a href="manage-products.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"> <img src="del.png"  width="30px" height="25px"></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
