...
?>										
										...
										<td><?php echo htmlentities($row['billingaddress'].",".$row['billingcity'].",".$row['billingstate']."-".$row['billingpincode']);?></td>
											<td><?php echo htmlentities($row['productname']);?><?php echo htmlentities($row['id']);?></td>
											<td><?php echo htmlentities($row['quantity']);?></td>
											<td><?php echo htmlentities($row['quantity']*$row['productprice'] );?></td>
											<td><?php echo htmlentities($row['orderdate']);?></td>
											<td>    <a href="updateorder.php?oid=<?php echo htmlentities($row['id']);?>" title="Update order" target="_blank">  <img src="up.jpg"  width="30px" height="25px">
											</td>
											</tr>
...
<?php include('include/footer.php');?>
	...
	<script>
		$(document).ready(function() {
			...
			$('.dataTables_paginate > a:first-child').append('<img src="pre.png"  width="25px" height="25px">');
			$('.dataTables_paginate > a:last-child').append('<img src="next.png"  width="25px" height="25px">');
		} );
	</script>
</body>
<?php } ?>