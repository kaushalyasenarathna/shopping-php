...
<?php } ?>
							...
							<li>
								<a href="manage-users.php">
									...
									<font color="#FFFFFF">Manage users</font>
								</a>
...
<a href="#">
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="category.php"><font color="#FFFFFF"> Create Category</font> </a></li>
                                <li><a href="subcategory.php"><font color="#FFFFFF">Sub Category </font></a></li>
                                <li><a href="insert-product.php"><font color="#FFFFFF">Insert Product </font></a></li>
                                <li><a href="manage-products.php"><font color="#FFFFFF">Manage Products </font></a></li>
                        
                            </ul>  
						<ul class="widget widget-menu unstyled">
							<li><a href="payment.php"><font color="#FFFFFF">Payment </font></a></li>
							
							<li>
								<a href="logout.php">
								 
									<font color="red" size="6">Logout</font>
								</a>
							</li>
						</ul>
