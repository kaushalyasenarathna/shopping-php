...
if(isset($_POST['submit']))
{
	...
	mysqli_query($con,"insert into productreviews(productId,quality,price,value,name,summary) values('$pid','$qty','$price','$value','$name','$summary')");
}
...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	<h3 class="section-title"><font color="#FFFF00"> Category</font></h3>
	    	...
	    	<div class="accordion-group">
	            <div class="accordion-heading">
	                <a href="category.php?cid=<?php echo $row['id'];?>"  class="accordion-toggle collapsed">
	                  <font color="#FFFFFF"> <?php echo $row['categoryName'];?></font>
	                </a>
	            </div>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								<li class="active"><a data-toggle="tab" href="#description">Size Chat</a></li>
